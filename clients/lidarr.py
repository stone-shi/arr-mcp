...
class LidarrClient:
    ...
    def get_blocklist(self, page: int = 1, page_size: int = 10) -> Dict[str, Any]:
    ...
    def add_import_list_exclusion(self, foreign_id: str, artist_name: str) -> Dict[str, Any]:
        payload = {"foreignId": foreign_id, "artistName": artist_name}
